...
namespace Aliencube.AzureFunctions.FunctionAppV3
{
    ...
    public class SampleHttpTrigger
    {
        ...
        [FunctionName(nameof(SampleHttpTrigger.GetPath))]
        [OpenApiOperation(operationId: "path", tags: new[] { "sample" }, Summary = "Gets the list of samples", Description = "This gets the list of samples.", Visibility = OpenApiVisibilityType.Important)]
        ...
        public async Task<IActionResult> GetPath(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "paths/{id:int}/categories/{category:regex(^[a-z]{{3,}}$)}")] HttpRequest req,
            int id,
            string category,
            ILogger log)
        {
        ...
        /// <param name="log"><see cref="ILogger"/> instance.</param>
        /// <returns><see cref="SampleResponseModel"/> instance.</returns>
        [FunctionName(nameof(SampleHttpTrigger.GetQuery))]
        [OpenApiOperation(operationId: "query", tags: new[] { "sample" }, Summary = "Gets the list of samples", Description = "This gets the list of samples.", Visibility = OpenApiVisibilityType.Important)]
        ...
        /// <param name="log"><see cref="ILogger"/> instance.</param>
        /// <returns><see cref="SampleResponseModel"/> instance.</returns>
        [FunctionName(nameof(SampleHttpTrigger.GetListResponse))]
        ...
        /// <param name="log"><see cref="ILogger"/> instance.</param>
        /// <returns><see cref="SampleResponseModel"/> instance.</returns>
        [FunctionName(nameof(SampleHttpTrigger.GetIListResponse))]
        [OpenApiOperation(operationId: "ilist", tags: new[] { "sample" }, Summary = "Gets the list of samples", Description = "This gets the list of samples.", Visibility = OpenApiVisibilityType.Important)]
        [OpenApiResponseBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(SampleResponseModel), Summary = "Sample response")]
        ...
        public async Task<IActionResult> GetIListResponse(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "ilists")] HttpRequest req,
            ILogger log)
        {
            var result = await this._function.AddLogger(log)
                                             .InvokeAsync<HttpRequest, IActionResult>(req)
